...
Singleton {
    // Formats
    readonly property list<string> validImageTypes: ["jpeg", "png", "gif", "webp", "tiff", "svg"]
    readonly property list<string> validImageExtensions: ["jpg", "jpeg", "png", "gif", "webp", "avif", "bmp", "tif", "tiff", "svg"]
