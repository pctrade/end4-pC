...
Singleton {
    ...
    property string unsplashApiToken: "p2iqmvnVenSlMXfslMg5u41eTkuGUuPSQa9Ciq7SxdI"
            ...
            "mapFunc": (response) => {
                ...
                return items.map(item => {
                    return {
                        ...
                        "sample_url": item.urls.regular,
                        "file_url": item.urls.full + "&w=1920&h=1080&fit=crop", // Forzar 1920x1080
                        "file_ext": "jpg",
