...
Singleton {
    ...
    // Download directory — saved straight into the top-level Wallpapers folder so the
    // local browser shows them alongside everything else (files keep the wallhaven_ prefix).
